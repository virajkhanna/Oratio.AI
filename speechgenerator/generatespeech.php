...
function getSpeech($motion, $debatetype, $wordLimit, $side) {
    ...
    // return "Test response from DebateAI: motion = $motion, side = $side, type = $debatetype, words = $wordLimit";
}
...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    $speech = getSpeech($motion, $debatetype, $wordLimit, $side);
