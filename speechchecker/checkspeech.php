...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    $motion = htmlspecialchars($motion, ENT_QUOTES, 'UTF-8');
    $debatetype = htmlspecialchars($debatetype, ENT_QUOTES, 'UTF-8');
    $side = htmlspecialchars($side, ENT_QUOTES, 'UTF-8');
    $speech = htmlspecialchars($speech, ENT_QUOTES, 'UTF-8');

    $feedback = checkSpeech($motion, $debatetype, $side, $speech);
